    ...
    internal class GameObjectInspector : Editor
    {
        ...
        class PreviewData : IDisposable
        {
            ...
            bool IsPrefabFileTooLargeForInteractivePreview(UnityObject prefabObject)
            {
                ...
                var artifactKey = AssetDatabaseExperimental.CreateArtifactKey(new GUID(guidString));
                var importResultID = AssetDatabaseExperimental.LookupArtifact(artifactKey);
                // The importResultID can be invalid if we are in the middle of an AssetDatabase.Refresh.
...
#pragma warning restore UA2001
        ...
        public static bool HasRenderableParts(GameObject go)
        {
            ...
            return s_RendererComponentsList.Exists(IsRendererUsableForPreview);
        }
