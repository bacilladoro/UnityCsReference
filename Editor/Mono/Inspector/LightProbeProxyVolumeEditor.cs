...
namespace UnityEditor
{
    ...
    internal class LightProbeProxyVolumeEditor : Editor
    {
        ...
        internal static readonly Color kGizmoLightProbeProxyVolumeColor = new Color(0xFF / 255f, 0xE5 / 255f, 0x94 / 255f, 0x80 / 255f);
        internal static readonly Color kGizmoLightProbeProxyVolumeHandleColor = new Color(0xFF / 255f, 0xE5 / 255f, 0xAA / 255f, 0xFF / 255f);
        ...
        private static class Styles
        {
            ...
            public static readonly string baseSceneEditingToolText = "<color=grey>Light Probe Proxy Volume Scene Editing Mode:</color> ";
    ...
    class LightProbeProxyVolumeTool : EditorTool
    {
        ...
        [NoAutoStaticsCleanup] // simple UI toggle set by HideAll(); default false is the correct fresh state after reload
