...
namespace Unity.UI.Builder
{
    internal static class BuilderConstants
    {
        ...
        public static readonly string InspectorStyleBindingPropertyNameVEPropertyName = "__unity-ui-builder-style-binding-property-name";
        ...
        public static readonly Dictionary<string, string> InspectorStylePropertiesTooltipsDictionary = new Dictionary<string, string>()
        {
            ...
            {"rotate", "Rotates the element based on the specified axis and angle. Note: Certain modifications, such as Z-axis rotation or back-face visibility, might not render correctly in UI Builder."},
            {"scale", "Resizes the visual element, including padding, borders, and margins. Negative values flip the element along the scale axis."},
            ...
            {"transform-origin", "Sets the point of origin for rotation, scaling, and translation. Controls where transformations are applied relative to the visual element."},
            {"transition", ""},
            ...
            {"translate", "Moves the position of the visual element horizontally or vertically."},
            ...
            {"-unity-material", "Specifies the Material asset used to render this element and its children."},
        ...
        // Messages
        public const string LibraryUxmlAttributeUsedInNonUxmlElementClassMessage =
            "Class {0} includes UxmlAttribute in its members, but the class does not contain a UxmlElement attribute. Please add the UxmlElement attribute to the class to enable code generation.";
