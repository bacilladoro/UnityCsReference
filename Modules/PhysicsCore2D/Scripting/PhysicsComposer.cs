...
using static Unity.U2D.Physics.PhysicsComposerScripting2D;
...
namespace Unity.U2D.Physics
{
    ...
    public readonly struct PhysicsComposer : IEquatable<PhysicsComposer>, IDisposable
    {
        ...
        /// Only PhysicsShape with a geometry of <see cref="PhysicsShape.ShapeType.Circle"/>, <see cref="PhysicsShape.ShapeType.Capsule"/> or <see cref="PhysicsShape.ShapeType.Polygon"/> will be used. All other types will be ignored.
        /// </summary>
        ...
        /// This should be in the range of 3 to <see cref="PhysicsConstants.MaxPolygonVertices"/>.
        /// The default is <see cref="PhysicsConstants.MaxPolygonVertices"/>.
        /// </summary>
        ...
        /// <summary>
        /// Get the geometry islands from a previous polygon geometry composition i.e. a call to <see cref="PhysicsComposer.CreatePolygonGeometry(Vector2, Allocator)"/> or <see cref="PhysicsComposer.CreateConvexHulls(Vector2, Allocator)"/>.
        ...
        /// <summary>
        /// Create <see cref="PolygonGeometry"/> from the composition by iterating all the layers added to the composition in the layer order specified, applying each operation specified.
