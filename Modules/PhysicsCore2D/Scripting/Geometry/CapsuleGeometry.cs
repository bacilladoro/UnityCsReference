...
namespace Unity.U2D.Physics
{
    ...
    public struct CapsuleGeometry
    {
        ...
        /// <param name="transform">The transform to apply.</param>
        public static void InverseTransform(Span<CapsuleGeometry> geometry, PhysicsTransform transform)
        {
            for (var i = 0; i < geometry.Length; ++i)
        ...
        /// <summary>
        /// Inverse-Transform a batch of geometry in place.
        /// The minimum absolute value component from the inverted scale will be used to scale the <see cref="CapsuleGeometry.radius"/>.
        /// </summary>
        /// <param name="geometry">The geometry to inverse-transform in place.</param>
        /// <param name="transform">The transform to apply.</param>
        /// <param name="scaleRadius">Whether to scale the radius of the shape.</param>
        public static void InverseTransform(Span<CapsuleGeometry> geometry, Matrix4x4 transform, bool scaleRadius)
        {
            for (var i = 0; i < geometry.Length; ++i)
