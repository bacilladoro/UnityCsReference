...
namespace Unity.U2D.Physics
{
    ...
    public readonly struct PhysicsWheelJoint : IPhysicsJoint<PhysicsWheelJoint>, IPhysicsHandle<PhysicsWheelJoint>, IEquatable<PhysicsWheelJoint>
    {
        #region Handle
        ...
        public PhysicsWheelJoint(PhysicsHandle physicsHandle) { m_JointHandle = new PhysicsJoint(physicsHandle); }
        ...
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] public static implicit operator PhysicsJoint(PhysicsWheelJoint joint) => joint.m_JointHandle;

        /// <summary>
        /// Cast to a <see cref="PhysicsWheelJoint"/> from the base <see cref="PhysicsJoint"/>.
        /// The provided joint must be a joint type of <see cref="PhysicsJoint.JointType.WheelJoint"/>.
        /// </summary>
        ...
        /// <summary>
        /// Create a <see cref="PhysicsWheelJoint"/> from the specified base joint.
        /// The provided joint must be a joint type of <see cref="PhysicsJoint.JointType.WheelJoint"/>.
        /// </summary>
        ...
        /// <undoc/>
        public override bool Equals(object obj) => obj is PhysicsWheelJoint other && Equals(other);

        /// <undoc/>
        public bool Equals(PhysicsWheelJoint other) => m_JointHandle.Equals(other.m_JointHandle);
