...
namespace Unity.U2D.Physics
{
    ...
    public readonly struct PhysicsDistanceJoint : IPhysicsJoint<PhysicsDistanceJoint>, IPhysicsHandle<PhysicsDistanceJoint>, IEquatable<PhysicsDistanceJoint>
    {
        #region Handle
        ...
        public PhysicsDistanceJoint(PhysicsHandle physicsHandle) { m_JointHandle = new PhysicsJoint(physicsHandle); }
        ...
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)] public static implicit operator PhysicsJoint(PhysicsDistanceJoint joint) => joint.m_JointHandle;
        ...
        /// <undoc/>
        public override bool Equals(object obj) => obj is PhysicsDistanceJoint other && Equals(other);

        /// <undoc/>
        public bool Equals(PhysicsDistanceJoint other) => m_JointHandle.Equals(other.m_JointHandle);
