...
{
    /// <summary>
    /// A joint definition used to specify properties when creating a <see cref="PhysicsSliderJoint"/>.
    /// </summary>
    [Serializable]
    ...
    public struct PhysicsSliderJointDefinition
    {
        ...
        /// <summary>
        /// Get a default <see cref="PhysicsSliderJoint"/> definition.
        /// </summary>
        ...
        [SerializeField] [Min(0.0f)] internal float m_MaxMotorForce;
        ...
        [SerializeField] [Range(0.00001f, 10.0f)] internal float m_DrawScale;
