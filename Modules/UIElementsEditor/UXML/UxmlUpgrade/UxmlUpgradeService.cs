...
namespace UnityEditor.UIElements
{
    ...
    public class UxmlUpgradeService
    {
        ...
        static readonly VisualTreeAssetExporter.ExportOptions s_ExportOptions = new VisualTreeAssetExporter.ExportOptions
        {
            ...
            styleExporterOptions = new StyleSheetExporter.UssExportOptions { ignorePropertyList = ["__unity_ui_builder_selected_stylesheet"] }
        };
        ...
        /// <summary>
        /// Gets the list of all registered upgraders.
        /// </summary>
        ...
        internal virtual void ApplyUpgradesInternal(List<VisualTreeAsset> assets, List<IUxmlUpgrader> upgradersToRun)
        {
            ...
            bool runningAttributeRenameUpgrader = false;

            foreach (var upgrader in upgradersToRun)
            {
                if (upgrader is UrlUpgrader)
                    runningUrlUpgrader = true;
                else if (upgrader is AttributeRenameUpgrader)
                    runningAttributeRenameUpgrader = true;
            }
            ...
            bool needsReimport = !runningUrlUpgrader || !runningAttributeRenameUpgrader;
                ...
                for (int i = 0; i < assets.Count; i++)
                {
                    ...
                    try
                    {
                        ...
                        if (needsReimport)
                        {
                            try
                            {
                                var reimportedVta = ReimportAsset(vta, runningUrlUpgrader, runningAttributeRenameUpgrader);
        ...
        internal virtual VisualTreeAsset ReimportAsset(VisualTreeAsset vta, bool enableUrlUpgrades, bool enableAttributeRenames)
        {
            var importer = new UXMLImporterImpl
            {
                enableAutomaticUrlUpgrades = enableUrlUpgrades,
                enableAutomaticAttributeRenames = enableAttributeRenames
            };
        ...
        /// <summary>
        /// Writes the given UXML string to the file corresponding to the given asset. This method is virtual to allow mocking in tests.
        /// </summary>
