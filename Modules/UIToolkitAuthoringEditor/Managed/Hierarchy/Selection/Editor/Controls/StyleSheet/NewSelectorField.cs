...
namespace Unity.UIToolkit.Editor
{
    ...
    internal partial class NewSelectorField : VisualElement, INotifyValueChanged<string>
    {
        ...
        static readonly string s_UssPath = "UIToolkitAuthoring/Inspector/StyleSheet/NewSelectorField.uss";
        static readonly string s_UxmlPath = "UIToolkitAuthoring/Inspector/StyleSheet/NewSelectorField.uxml";
        ...
        public NewSelectorField()
        {
            ...
            textEdition.RegisterCallback<FocusEvent>(evt =>
            {
                ...
                if (string.IsNullOrEmpty(value) || m_RefocusOnNextBlur)
                {
                    ...
                    value = UssSelectorClassNameSymbol;
            ...
            m_TextField.RegisterCallback<ChangeEvent<string>>((evt) =>
            {
                ...
                m_FieldFocusStep = value == UssSelectorClassNameSymbol ? FieldFocusStep.NeedsSelectionOverride : FieldFocusStep.Idle;
            ...
            textEdition.RegisterCallback<BlurEvent>((evt) =>
            {
                ...
                else if (string.IsNullOrEmpty(value) || value == UssSelectorClassNameSymbol)
                {
                    value = string.Empty;
                    m_OptionsPopup.SetEnabled(false);
                }
        ...
        {
            if (!string.IsNullOrEmpty(evt.newValue) && evt.newValue != UssSelectorClassNameSymbol)
            {
