...
namespace UnityEngine.TextCore.Text
{
    ...
    internal static class TextGeneratorUtilities
    {
        ...
        public static TextStyle GetStyle(TextGenerationSettings generationSetting, int hashCode)
        {
            ...
            TextStyleSheet styleSheet = null;
        ...
        static readonly HashSet<uint> k_EmojiLookup = new HashSet<uint>(new uint[] {
        ...
        static readonly HashSet<uint> k_EmojiPresentationFormLookup = new HashSet<uint> (new uint[] {
