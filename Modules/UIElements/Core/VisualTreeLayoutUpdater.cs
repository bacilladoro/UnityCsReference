...
namespace UnityEngine.UIElements
{
    ...
    internal partial class VisualTreeLayoutUpdater : BaseVisualTreeUpdater
    {
        ...
        {
            m_TextJobSystem.PrepareShapingBeforeLayout(panel);
        ...
        private TextJobSystem m_TextJobSystem = new();
