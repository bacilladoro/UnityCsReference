...
namespace UnityEngine.UIElements
{
    internal partial class ResolvedStyleAccessPropertyBag
    {
        ...
        class BackdropFilterProperty : ResolvedListProperty<FilterFunction>
        {
            public override string Name => nameof(IResolvedStyle.backdropFilter);
            public override string ussName => "backdrop-filter";
            public override bool IsReadOnly => true;

            public override IEnumerable<FilterFunction> GetValue(ref ResolvedStyleAccess container) => ((IResolvedStyle)container).backdropFilter;
        ...
        class TextShadowProperty : ResolvedTextShadowProperty
        {
            public override string Name => nameof(IResolvedStyle.textShadow);
            public override string ussName => "text-shadow";
            public override bool IsReadOnly => true;

            public override TextShadow GetValue(ref ResolvedStyleAccess container) => ((IResolvedStyle)container).textShadow;
            public override void SetValue(ref ResolvedStyleAccess container, TextShadow value) => throw new System.InvalidOperationException();
        }
