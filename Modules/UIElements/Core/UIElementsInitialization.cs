...
namespace UnityEngine.UIElements
{
    static class UIElementsInitialization
    {
        static readonly ProfilerMarker s_InitializeUIElementsManagedMarker =
            new ProfilerMarker(ProfilerCategory.UIToolkit, "InitializeUIElementsManaged");
        ...
        internal static void RegisterBuiltInPropertyBags()
        {
            ...
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleEnum<AnimationDirection>), () => new StyleValuePropertyBag<StyleEnum<AnimationDirection>, AnimationDirection>());
            ...
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleEnum<GridAutoFlow>), () => new StyleValuePropertyBag<StyleEnum<GridAutoFlow>, GridAutoFlow>());
            ...
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleList<AnimationIterationCount>), () => new StyleValuePropertyBag<StyleList<AnimationIterationCount>, List<AnimationIterationCount>>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(AnimationIterationCount), () => new AnimationIterationCount.PropertyBag());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(List<AnimationIterationCount>), () => new ListPropertyBag<AnimationIterationCount>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleList<float>), () => new StyleValuePropertyBag<StyleList<float>, List<float>>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(List<float>), () => new ListPropertyBag<float>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleList<UIAnimationClip>), () => new StyleValuePropertyBag<StyleList<UIAnimationClip>, List<UIAnimationClip>>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(List<UIAnimationClip>), () => new ListPropertyBag<UIAnimationClip>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleList<AnimationDirection>), () => new StyleValuePropertyBag<StyleList<AnimationDirection>, List<AnimationDirection>>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(List<AnimationDirection>), () => new ListPropertyBag<AnimationDirection>());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleList<AnimationPlayState>), () => new StyleValuePropertyBag<StyleList<AnimationPlayState>, List<AnimationPlayState>>());
            ...
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(GridLine), () => new GridLine.PropertyBag());
            PropertyBagLazyInitialization.AddLazyRegistration(typeof(StyleList<GridTrackSize>), () => new StyleValuePropertyBag<StyleList<GridTrackSize>, List<GridTrackSize>>());
